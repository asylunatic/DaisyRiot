...
void rgb2spec_fetch(RGB2Spec *model, float rgb[3], float out[RGB2SPEC_N_COEFFS]) {
	assert(rgb[0] >= 0.f && rgb[1] >= 0.f && rgb[2] >= 0.f &&
		rgb[0] <= 1.f && rgb[1] <= 1.f && rgb[2] <= 1.f);
...
__m256 rgb2spec_eval_avx(float coeff[RGB2SPEC_N_COEFFS], __m256 lambda) {
	__m256 c0 = _mm256_set1_ps(coeff[0]), c1 = _mm256_set1_ps(coeff[1]),
		c2 = _mm256_set1_ps(coeff[2]),
		h = _mm256_set1_ps(.5f), o = _mm256_set1_ps(1.f);
...
__m512 rgb2spec_eval_avx512(float coeff[RGB2SPEC_N_COEFFS], __m512 lambda) {
	__m512 c0 = _mm512_set1_ps(coeff[0]), c1 = _mm512_set1_ps(coeff[1]),
		c2 = _mm512_set1_ps(coeff[2]),
		h = _mm512_set1_ps(.5f), o = _mm512_set1_ps(1.f);
